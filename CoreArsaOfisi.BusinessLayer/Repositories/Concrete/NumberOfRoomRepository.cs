...
{
    class NumberOfRoomRepository:Repository<NumberOfRoom>, INumberOfRoomRepository
    {
        public NumberOfRoomRepository(u9673886_arsdbContext _ArsdbContext):base(_ArsdbContext)
        {
