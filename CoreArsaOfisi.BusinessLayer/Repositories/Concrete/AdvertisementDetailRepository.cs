...
{
    class AdvertisementDetailRepository:Repository<AdvertisementDetail>,IAdvertisementDetailRepository
    {
        public AdvertisementDetailRepository(u9673886_arsdbContext _ArsdbContext):base(_ArsdbContext)
        {
