...
{
    class AdvertisementTypeRepository:Repository<AdvertisementType>, IAdvertisementTypeRepository
    {
        public AdvertisementTypeRepository(u9673886_arsdbContext _ArsdbContext):base(_ArsdbContext)
        {
