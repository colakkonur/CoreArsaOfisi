...
{
    class AdvertisementTypePropertyRepository:Repository<AdvertisementTypeProperty>, IAdvertisementTypePropertyRepository
    {
        public AdvertisementTypePropertyRepository(u9673886_arsdbContext _ArsdbContext):base(_ArsdbContext)
        {
